...
$toolDir = Join-Path $workspacePath "tools\invoice_image_to_spreadsheet_app"
$python = "C:\Users\user\AppData\Local\Programs\Python\Python312\python.exe"
$entry = Join-Path $toolDir "invoice_image_to_spreadsheet_gui.py"
$distDir = Join-Path $toolDir "dist"
$buildDir = Join-Path $toolDir "build"
$specDir = $buildDir
$asciiName = "invoice_image_to_spreadsheet"
$targetName = [Text.Encoding]::UTF8.GetString([Convert]::FromBase64String("6YCy6LKo5ZauT0NS5om55qyh6L2J6Kmm566X6KGoLmV4ZQ=="))
